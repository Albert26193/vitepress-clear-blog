  ...
  shortcuts: [
    [
      ...
      [
        ...
        'dark:hover:border-blue hover:border-blue border'
      ]
    ],
    ...
    [
      'common-border',
      [
        'inline-flex mr-4 rounded px-4 py-2 font-bold',
        'focus:outline-none focus-visible:ring',
        'hover:cursor-default transition duration-100 animate-shadow',
    ...
    [
      ...
      [
        ...
        'dark:border-gray-300/90 dark:text-gray-300/90'
      ]
    ],
    [
      'tag-active',
